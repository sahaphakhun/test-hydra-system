...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // ดึงข้อมูลบัญชี LINE
        const lineAccounts = yield LineAccount_1.LineAccount.find(filter)
            .skip(skip)
            .limit(Number(limit))
            .sort({ createdAt: -1 });
        // นับจำนวนบัญชีทั้งหมด
        const total = yield LineAccount_1.LineAccount.countDocuments(filter);
        res.status(200).json({
            success: true,
            data: lineAccounts,
            pagination: {
...
router.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const lineAccount = yield LineAccount_1.LineAccount.findById(req.params.id);
        if (!lineAccount) {
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingAccount = yield LineAccount_1.LineAccount.findOne({
            userId,
            lineConfigId
        });
        if (existingAccount) {
        ...
        // สร้างบัญชีใหม่
        const lineAccount = yield LineAccount_1.LineAccount.create({
            displayName,
            userId,
            pictureUrl,
            statusMessage,
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const lineAccount = yield LineAccount_1.LineAccount.findByIdAndDelete(req.params.id);
        if (!lineAccount) {
            return res.status(404).json({ success: false, message: 'ไม่พบบัญชี LINE' });
        }
...
router.post('/:id/tags', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { tags } = req.body;
...
// ลบแท็กจากบัญชี LINE
router.delete('/:id/tags', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { tags } = req.body;
        if (!tags || !Array.isArray(tags)) {
            return res.status(400).json({ success: false, message: 'ต้องระบุแท็กเป็นอาร์เรย์' });
