...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // ดึงข้อมูลแคมเปญ
        const campaigns = yield campaign_1.Campaign.find(filter)
            .skip(skip)
            .limit(Number(limit))
            .sort({ createdAt: -1 })
        ...
        const total = yield campaign_1.Campaign.countDocuments(filter);
        res.status(200).json({
            success: true,
            data: campaigns,
            pagination: {
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const messageTemplate = yield messageTemplate_1.MessageTemplate.findById(messageTemplateId);
        if (!messageTemplate) {
            return res.status(400).json({ success: false, message: 'ไม่พบเทมเพลตข้อความ' });
        }
        // ตรวจสอบว่าการตั้งค่า LINE มีอยู่จริงหรือไม่
        const lineConfig = yield lineConfig_1.LineConfig.findById(lineConfigId);
        if (!lineConfig) {
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield campaign_1.Campaign.findByIdAndDelete(req.params.id);
...
router.post('/:id/start', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const targetCount = yield LineAccount_1.LineAccount.countDocuments(filter);
        // อัปเดตสถานะและสถิติ
